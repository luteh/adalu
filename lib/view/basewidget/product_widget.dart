            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (productModel.discount > 0) SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                  Row(children: [
                    Icon(Icons.star_rounded, color: Provider.of<ThemeProvider>(context).darkTheme ? Colors.white : Colors.orange, size: 15),
                    SizedBox(width: 3),
                    ...
                    SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                    Text("Stock : ${productModel.currentStock.toString()}", style: robotoRegular.copyWith(
                      color: Colors.white,
                      fontSize: Dimensions.FONT_SIZE_SMALL,
                    )),
                  ]),
            ...
            child: Container(
              ...
              child: Center(
                child: Text(
                  ...
                  style: robotoRegular.copyWith(color: Colors.white, fontSize: Dimensions.FONT_SIZE_EXTRA_SMALL),
                ),
              ),
            ),
          ) : SizedBox.shrink(),
