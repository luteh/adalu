...
import 'package:flutter_rekret_ecommerce/view/screen/auth/widget/sign_in_widget.dart';
import 'package:flutter_rekret_ecommerce/view/screen/auth/widget/sign_up_widget.dart';
            ...
            builder: (context, auth, child) => SafeArea(
              child: Column(
                ...
                children: [
                  ...
                  // for logo with text
                  Image.asset(Images.logo_with_with_name, height: 150, width: 200),
