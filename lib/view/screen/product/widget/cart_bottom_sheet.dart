          ...
          child: Consumer<ProductDetailsProvider>(
            builder: (context, details, child) {
              ...
              if (_variantName != null) {
                ...
                print(jsonEncode(_variationList));
                _variationList.forEach((variation) {
                  if (isFirst) {
                    ...
                    variationType = '$variationType-$variation';
                    print("Variation type second = $variationType");
                  }
                });
              }
              double price = product.getCalculationUnitPrice();
              ...
              for (Variation variation in product.variation) {
                if (variation.type.replaceAll(" ", "") ==
                  ...
                  print("Variation type 1 = " + variation.type);
              ...
              double priceWithDiscount = product.getCalculationUnitPrice();
