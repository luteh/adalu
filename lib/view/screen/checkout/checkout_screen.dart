...
import 'package:flutter_rekret_ecommerce/view/screen/checkout/widget/shipping_method_bottom_sheet.dart';
...
class _CheckoutScreenState extends State<CheckoutScreen> {
            ...
            BlocListener<ShippingPartnerBloc, ShippingPartnerState>(
              ...
              listener: (context, ShippingPartnerState shippingPartnerState) {
                ...
                if (shippingPartnerState.isSelectedComplete()) {
                  ...
                  print(listCart(shippingPartnerState, _shippingCost));
              ...
              listener: (context, CheckoutState checkoutState) {
                if (checkoutState.isPaymentSuccess()) {
                  ...
                  Provider.of<CartProvider>(context, listen: false)
                      .removeCheckoutProduct(widget.cartList);
  ...
  buttonPressed(ShippingPartnerState shippingPartnerState,
  ...
  List<Cart> listCart(shippingPartnerState, _shippingCost) {
    ...
    for (int index = 0; index < widget.cartList.length; index++) {
      ...
      carts.add(Cart(
        ...
        'amount',
        index == 0
            ? int.tryParse(shippingPartnerState.courierSelected.serviceTypeCode)
            : 1,
        cart.variant,
                          ...
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (_) => ShippingPartnerScreen(
                                      shippingPartnerBloc, districtId)));
                        }
                      },
                      child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          ...
                          return Padding(
                            ...
                            child: Row(children: [
                              FadeInImage.assetNetwork(
                                ...
                                height: 50,
                                image:
                                    '${Provider.of<SplashProvider>(context, listen: false).baseUrls.productThumbnailUrl}/${widget.cartList[index].image}',
                                      ...
                                      if (shippingPartnerState
                                        ...
                                        if (_controller.text.isNotEmpty) {
                                          Provider.of<CouponProvider>(context,
                                                  listen: false)
                                              .initCoupon(_controller.text,
                                                  checkoutState.orderPlaceModel)
                                              .then((value) {
                                            if (value > 0) {
                                              // TODO : Update couponVoucher
                                              checkoutBloc.add(
    ...
    return Container(
      ...
      child: Consumer<OrderProvider>(
        builder: (context, order, child) {
          ...
          Widget totalWidget = TitleRow(title: getTranslated('TOTAL', context));
          ...
          return Column(
              ...
              children: [
                ...
                AmountWidget(
                    title: "Insurance",
                    amount:
                        PriceConverter.convertPrice(context, _insuranceAmount)),
