                      ...
                      child: Padding(
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                PriceConverter.convertPrice(context, megaProvider.flashDealList[index].getCalculationUnitPrice()),
                              ...
                              Row(children: [
                                Expanded(
                                  child: Text(
                                    megaProvider.flashDealList[index].discount > 0 ? PriceConverter.convertPrice(context, megaProvider.flashDealList[index].getPriceWithTax()) : '',
