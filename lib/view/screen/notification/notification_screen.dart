...
import 'package:flutter_rekret_ecommerce/view/screen/notification/widget/notification_dialog.dart';
                    ...
                    return InkWell(
                      ...
                      child: Container(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text(
                            DateFormat('hh:mm  dd/MM/yyyy').format(DateConverter.convertStringToDatetime(notification.notificationList[index].createdAt)),
