...
import 'package:flutter_rekret_ecommerce/view/screen/chat/inbox_screen.dart';
...
import 'package:flutter_rekret_ecommerce/view/screen/category/all_category_screen.dart';
...
import 'package:flutter_rekret_ecommerce/view/screen/profile/address_list_screen.dart';
import 'package:flutter_rekret_ecommerce/view/screen/profile/profile_screen.dart';
import 'package:flutter_rekret_ecommerce/view/screen/setting/settings_screen.dart';
                                ...
                                : profile.userInfoModel == null
                                    ...
                                    : ClipRRect(
                                        ...
                                        child: FadeInImage.assetNetwork(
                                          ...
                                          fit: BoxFit.fill,
                                          image:
                                              '${AppConstants.BASE_URL_ASSETS}${Provider.of<SplashProvider>(context, listen: false).baseUrls.customerImageUrl}/${profile.userInfoModel.image}',
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  ListTile(
                    leading: Image.asset(Images.logo_with_name_image,
                        width: 25,
                        height: 25,
                        fit: BoxFit.fill,
