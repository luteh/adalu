...
import 'package:flutter_rekret_ecommerce/data/model/response/user_info_model.dart';
  ...
  _updateUserAccount() async {
    ...
    if (Provider.of<ProfileProvider>(context, listen: false)
      ...
      Fluttertoast.showToast(
        msg: 'Change something to update',
      ...
      //     backgroundColor: ColorResources.RED));
      Fluttertoast.showToast(
        msg: getTranslated('NAME_FIELD_MUST_BE_REQUIRED', context),
        toastLength: Toast.LENGTH_LONG,
        gravity: ToastGravity.BOTTOM_LEFT,
        timeInSecForIosWeb: 2,
        backgroundColor: ColorResources.RED,
      ...
      //     backgroundColor: ColorResources.RED));
      Fluttertoast.showToast(
        msg: getTranslated('EMAIL_MUST_BE_REQUIRED', context),
        toastLength: Toast.LENGTH_LONG,
        gravity: ToastGravity.BOTTOM_LEFT,
        timeInSecForIosWeb: 2,
        backgroundColor: ColorResources.RED,
      ...
      //     backgroundColor: ColorResources.RED));
      Fluttertoast.showToast(
        msg: getTranslated('PHONE_MUST_BE_REQUIRED', context),
        toastLength: Toast.LENGTH_LONG,
        gravity: ToastGravity.BOTTOM_LEFT,
        timeInSecForIosWeb: 2,
        backgroundColor: ColorResources.RED,
      ...
      //     backgroundColor: ColorResources.RED));
      Fluttertoast.showToast(
        msg: getTranslated('PASSWORD_DID_NOT_MATCH', context),
        toastLength: Toast.LENGTH_LONG,
        gravity: ToastGravity.BOTTOM_LEFT,
        timeInSecForIosWeb: 2,
        backgroundColor: ColorResources.RED,
